...
$_SESSION['random_number'] = bin2hex(random_bytes(16)); 
}
...
if (isset($_COOKIE['authToken']) && $_COOKIE['authToken'] === $_SESSION['random_number']) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === 'admin' && $password === 'secret') {
        setcookie('authToken', $_SESSION['authToken'], time() + 60, '/', '', false, true); // Le Cookie est initialisé et valable pendant 1 heure (3600 secondes) 
